...
STORY_PATH = Path(__file__).resolve().parent / "../../user_stories/story__provider_attempt_outcome.md"
CONTRACT_PATH = Path(__file__).resolve().parent / "../../user_stories/contracts/provider_attempt_outcome.contract.md"
